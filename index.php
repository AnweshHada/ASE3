					...
					<div class="tab-1 resp-tab-content roundtrip">
						<form action="book_flight.php" method="post">
							...
							<div class="numofppl">
								...
								<div class="class">
								<h3 style="color: rgba(255, 255, 255, 0.767);">Fire Exit Seat</h3>
								<select id="w3_country1" name="f_class"
									onchange="change_country(this.value)" class="frm-field required">
									<option value="E">Opt In</option>  
									<option value="B">Opt Out</option>   
								</select>
							</div>
								<div class="clear"></div>
							</div>
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<div class="text-light text-center">&copy; <?php echo date('Y')?> - Developed By Anwesh<br><br></div>
	<!-- <p>----------</p> -->
